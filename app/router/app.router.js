...
var validate = require('../framework/validation');
  ...
  module.exports = function(router) {
    ...
    router.get('/appointments/:phoneNumber', appointmentCtrl.getConsumerAppointment);
    router.post('/appointments/:phoneNumber',  appointmentCtrl.storeConsumerAppointment);
    router.put('/appointments/:phoneNumber',  appointmentCtrl.updateConsumerAppointment);
    router.get('/appointments/:phoneNumber/:idProperty', appointmentCtrl.getBusinessAppointment);
    router.post('/appointments/:phoneNumber/:idProperty', appointmentCtrl.storeBusinessAppointment);
    router.put('/appointments/:phoneNumber/:idProperty', appointmentCtrl.updateBusinessAppointment);
